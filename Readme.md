...
| [What is the history behind React evolution](#What-is-the-history-behind-React-evolution)                                                                                                                                       |
...
| [Does the lazy function support named exports](#does-the-lazy-function-support-named-exports)                                                                                                                                   |
...
| [What are the advantages of React](#what-are-the-advantages-of-react)                                                                                                                                                           |
...
| [What is ReactDOMServer](#what-is-reactdomserver)                                                                                                                                                                               |
...
| [How do you conditionally render components](#how-do-you-conditionally-render-components)                                                                                                                                       |
...
| [How you implement Server-Side Rendering or SSR](#how-you-implement-server-side-rendering-or-ssr)                                                                                                                               |
| [How to enable production mode in React](#how-to-enable-production-mode-in-react)                                                                                                                                               |
...
| [What are the Pointer Events supported in React](#what-are-the-pointer-events-supported-in-react)                                                                                                                               |
...
| [How to combine multiple inline style objects](#how-to-combine-multiple-inline-style-objects)                                                                                                                                   |
...
| [Why you can't update props in React](#why-you-cant-update-props-in-react)                                                                                                                                                      |
...
| [What are the popular packages for animation](#what-are-the-popular-packages-for-animation)                                                                                                                                     |
...
| [What is the purpose of push and replace methods of history](#what-is-the-purpose-of-push-and-replace-methods-of-history)                                                                                                       |
...
| [How to implement default or NotFound page](#how-to-implement-default-or-notfound-page)                                                                                                                                         |
...
| [What are the advantages of Jest over Jasmine](#what-are-the-advantages-of-jest-over-jasmine)                                                                                                                                   |
| [Give a simple example of Jest test case](#give-a-simple-example-of-jest-test-case)                                                                                                                                             |
| **React Redux**                                                                                                                                                                                                                 |
| [What is Flux](#what-is-flux)                                                                                                                                                                                                   |
| [What is Redux](#what-is-redux)                                                                                                                                                                                                 |
| [What are the core principles of Redux](#what-are-the-core-principles-of-redux)                                                                                                                                                 |
| [What are the downsides of Redux compared to Flux](#what-are-the-downsides-of-redux-compared-to-flux)                                                                                                                           |
| [What is the difference between mapStateToProps() and mapDispatchToProps()](#what-is-the-difference-between-mapstatetoprops-and-mapdispatchtoprops)                                                                             |
| [Can I dispatch an action in reducer](#can-i-dispatch-an-action-in-reducer)                                                                                                                                                     |
| [How to access Redux store outside a component](#how-to-access-redux-store-outside-a-component)                                                                                                                                 |
...
| [Why are Redux state functions called reducers](#why-are-redux-state-functions-called-reducers)                                                                                                                                 |
| [How to make AJAX request in Redux](#how-to-make-ajax-request-in-redux)                                                                                                                                                         |
| [Should I keep all component's state in Redux store](#should-i-keep-all-components-state-in-redux-store)                                                                                                                        |
...
| [What are the different ways to write mapDispatchToProps()](#what-are-the-different-ways-to-write-mapdispatchtoprops)                                                                                                           |
| [What is the use of the ownProps parameter in mapStateToProps() and mapDispatchToProps()](#what-is-the-use-of-the-ownprops-parameter-in-mapstatetoprops-and-mapdispatchtoprops)                                                 |
...
| [What are Redux selectors and Why use them](#what-are-redux-selectors-and-why-use-them)                                                                                                                                         |
...
| [How to test React Native apps](#how-to-test-react-native-apps)                                                                                                                                                                 |
| [How to do logging in React Native](#how-to-do-logging-in-react-native)                                                                                                                                                         |
| [How to debug your React Native](#how-to-debug-your-react-native)                                                                                                                                                               |
...
| [Why is DevTools not loading in Chrome for local files](#why-is-devtools-not-loading-in-chrome-for-local-files)                                                                                                                 |
...
| [How Redux Form initialValues get updated from state](#how-redux-form-initialvalues-get-updated-from-state)                                                                                                                     |
| [How React PropTypes allow different type for one prop](#how-react-proptypes-allow-different-types-for-one-prop)                                                                                                                |
...
| [In which scenarios do error boundaries not catch errors](#in-which-scenarios-do-error-boundaries-not-catch-errors)                                                                                                             |
| [What is the behavior of uncaught errors in react 16](#what-is-the-behavior-of-uncaught-errors-in-react-16)                                                                                                                     |
| [What is the proper placement for error boundaries](#what-is-the-proper-placement-for-error-boundaries)                                                                                                                         |
...
| [How to prevent a function from being called multiple times](#how-to-prevent-a-function-from-being-called-multiple-times)                                                                                                       |
...
| [How do you say that props are read only](#how-do-you-say-that-props-are-read-only)                                                                                                                                             |
| [What are the conditions to safely use the index as a key](#what-are-the-conditions-to-safely-use-the-index-as-a-key)                                                                                                           |
...
| [Do I need to rewrite all my class components with hooks](#do-i-need-to-rewrite-all-my-class-components-with-hooks)                                                                                                             |
...
| [What are the differences between useEffect and useLayoutEffect hooks](#what-are-the-differences-between-useEffect-and-useLayoutEffect-hooks)                                                                                   |
...
| [What are the rules of JSX](#what-are-the-rules-of-JSX)                                                                                                                                                                         |
| [What is the reason behind multiple JSX tags to be wrapped](#what-is-the-reason-behind-multiple-JSX-tags-to-be-wrapped)                                                                                                         |
| [How do you prevent mutating array variables](#how-do-you-prevent-mutating-array-variables)                                                                                                                                     |
| [What are capture phase events](#what-are-capture-phase-events)                                                                                                                                                                 |
...
| [Is it possible to prevent automatic batching](#is-it-possible-to-prevent-automatic-batching)                                                                                                                                   |
| [What is React hydration](#what-is-react-hydration)                                                                                                                                                                             |
| [How do you update objects inside state](#how-do-you-update-objects-inside-state)                                                                                                                                               |
...
| [What are the benefits of preventing the direct state mutations](#what-are-the-benefits-of-preventing-the-direct-state-mutations)                                                                                               |
...
| [What will happen by defining nested function components](#what-will-happen-by-defining-nested-function-components)                                                                                                             |
| [Can I use keys for non-list items](#can-i-use-keys-for-non-list-items)                                                                                                                                                         |
| [What are the guidelines to be followed for writing reducers](#what-are-the-guidelines-to-be-followed-for-writing-reducers)                                                                                                     |
| [What is useReducer hook Can you describe its usage](#what-is-use-reducer-hook-Can-you-describe-its-usage)                                                                                                                      |
| [How do you compare useState and useReducer](#how-do-you-compare-use-state-and-use-reducer)                                                                                                                                     |
| [How does context works using useContext hook](#how-does-context-works-using-use-context-hook)                                                                                                                                  |
| [What are the use cases of useContext hook](#what-are-the-use-cases-of-use-context-hook)                                                                                                                                        |
...
| [What will happen if you use setState in constructor](#what-will-happen-if-you-use-setstate-in-constructor)                                                                               |
| [Is it good to use setState() in componentWillMount() method](#is-it-good-to-use-setstate-in-componentwillmount-method)                                                                   |
...
| [What is CRA and its benefits](#what-is-cra-and-its-benefits)                                                                                                                             |
| [What is the lifecycle methods order in mounting](#what-is-the-lifecycle-methods-order-in-mounting)                                                                                       |
...
| [What is the purpose of getDerivedStateFromProps() lifecycle method](#what-is-the-purpose-of-getderivedstatefromprops-lifecycle-method)                                                   |
| [What is the purpose of getSnapshotBeforeUpdate() lifecycle method](#what-is-the-purpose-of-getsnapshotbeforeupdate-lifecycle-method)                                                     |
| [What is the recommended way for naming components](#what-is-the-recommended-way-for-naming-components)                                                                                   |
...
| [Why we need to pass a function to setState()](#why-we-need-to-pass-a-function-to-setstate)                                                                                               |
| [Why is isMounted() an anti-pattern and what is the proper solution](#why-is-ismounted-an-anti-pattern-and-what-is-the-proper-solution)                                                   |
| [What is the difference between constructor and getInitialState](#what-is-the-difference-between-constructor-and-getinitialstate)                                                         |
...
| [What is the difference between setState and replaceState methods](#what-is-the-difference-between-setstate-and-replacestate-methods)                                                     |
...
| [Is it possible to use React without rendering HTML](#is-it-possible-to-use-react-without-rendering-html)                                                                                 |
| [What are the possible ways of updating objects in state](#what-are-the-possible-ways-of-updating-objects-in-state)                                                                       |
| [What are the approaches to include polyfills in your create-react-app](#what-are-the-approaches-to-include-polyfills-in-your-create-react-app)                                           |
| [How to use https instead of http in create-react-app](#how-to-use-https-instead-of-http-in-create-react-app)                                                                             |
| [How to avoid using relative path imports in create-react-app](#how-to-avoid-using-relative-path-imports-in-create-react-app)                                                             |
...
| [How to dispatch an action on load](#how-to-dispatch-an-action-on-load)                                                                                                                   |
...
| [Why do you not need error boundaries for event handlers](#why-do-you-not-need-error-boundaries-for-event-handlers)                                                                       |
...
| [How do you pass arguments to an event handler](#how-do-you-pass-arguments-to-an-event-handler)                                                                                           |
...
| [What is the purpose of renderToNodeStream method](#what-is-the-purpose-of-rendertonodestream-method)                                                                                     |
| [How do you get redux scaffolding using create-react-app](#how-do-you-get-redux-scaffolding-using-create-react-app)                                                                       |
